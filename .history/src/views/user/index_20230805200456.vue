    ...
    <van-pull-refresh v-model="reLoad" @refresh="refresh">
      <div class="mainBox">
        ...
        <van-cell-group title="我的易班">
          <van-cell title="易班账号绑定" value="" is-link :url="bindURL" />
        </van-cell-group>
...
const bindURL = import.meta.env.VITE_APP_API_BASE_URL + '/user/yiban/bind?id=' + userStore.uid + '&callback=' + import.meta.env.VITE_APP_YIBANBIND_CALLBACK
