    ...
    <van-config-provider :theme-vars="themeVars">
      ...
      <van-form @submit="onSubmit">
        ...
        <van-cell-group inset title="联系方式（任意）">
          <van-field v-model="contact['电话']" readonly label="手机号" placeholder="输入手机号" />
          <van-field v-model="contact['QQ']" readonly label="QQ" placeholder="输入QQ号" />
          <van-field v-model="contact['微信']" readonly label="微信" placeholder="输入微信号" />
          <van-field v-model="contact['邮箱']" readonly label="邮箱" placeholder="输入邮箱" />
        </van-cell-group>
