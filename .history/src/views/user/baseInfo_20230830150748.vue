    ...
    <van-config-provider :theme-vars="themeVars">
      ...
      <van-form @submit="onSubmit">
        <van-cell-group inset>
          ...
          <van-field v-model="enrollmentYear" readonly name="picker" label="年级" placeholder="选择年级"
        ...
        <van-popup v-model:show="showDepartmentPicker" position="bottom">
          <van-picker :columns="yearColumns" @confirm="onDepartmentConfirm" @cancel="showDepartmentPicker = false" />
        </van-popup>
