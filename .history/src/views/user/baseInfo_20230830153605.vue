  ...
  <div>
    <van-config-provider :theme-vars="themeVars">
      ...
      <van-form @submit="onSubmit">
        ...
        <van-cell-group inset title="联系方式(可选，任意)">
          <van-field v-model="sex" readonly label="手机号" placeholder="输入手机号" />
          <van-field v-model="year" readonly label="QQ" placeholder="输入QQ号" />
          <van-field v-model="myDepartmentName" readonly label="微信" placeholder="输入微信号" />
          <van-field v-model="myDepartmentName" readonly label="邮箱" placeholder="输入邮箱" />
        </van-cell-group>
