...
const avatar = ref(useStore)

const userInfo = [
    { icon: 'manager', key: '姓名', content: useStore.name },
    { icon: 'invitation', key: '联系方式', content: '不能为null' }, // Object.values(useStore.contact)[0]
...
<template>
    <div class="container">
        ...
        <div class="avatar">
            <van-image round width="8rem" height="8rem" fit="cover" position="center" :src="useSrore.avatar" />
        </div>
        ...
        <div id="userInfo">
            <div class="infoBox" v-for="(item, index) in userInfo" :key="index">
                ...
                <div class="tools">
                    <van-icon name="arrow" v-if="index != 0" @click="action(item, index)" size="30" color="#BEBAB3" />
