...
import { commentTemplate, templateType } from "@/api/types/courses";
...
const commentTemplateListParams = ref<templateType>({
  page: 1,
  pageSize: 10,
  level: 0,
  type: 0,
...
const selfCommentTemplateList = ref<commentTemplate[]>();
