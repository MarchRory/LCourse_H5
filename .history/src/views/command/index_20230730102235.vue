...
const isCommentSuccess = ref(true)
...
<template>
    <div class="container">
        ...
        <div class="main" v-if="!isCommentSuccess">
            <van-image width="90%" height="230" fit="cover" lazy-load :src="defaultCover" />
        ...
        <div class="res">
            ...
            <div class="resText">
                <div style="font-size: 30px; font-weight: 300; color: #80807f;">
