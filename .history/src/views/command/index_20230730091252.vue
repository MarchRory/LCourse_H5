...
const submit = () => {
    if (toCourse.value && toSelf.value) {

    } else {
        showFailToast('还有评价没有填写哦')
    }
}
</script>
...
<template>
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="commentToCourse">
                <div style="text-align: left;margin-left: 20px;">课程评价</div>
                <van-cell-group inset>
                    <van-field v-model="toCourse" rows="4" autosize maxlength="200" type="textarea" show-word-limit
                        placeholder="请输入对课程的评价" />
                </van-cell-group>
                <div class="anonymous">
                    <van-switch v-model="isAnonymous" @change="handleSwitchChange" size="22px" active-color="#E3562A"
            ...
            <div class="commmentToSelf">
                ...
                <van-cell-group inset>
                    <van-field v-model="toSelf" rows="4" autosize maxlength="200" type="textarea" show-word-limit
                        placeholder="请输入自己参加课程的感受" />
                </van-cell-group>
            </div>
        </div>
