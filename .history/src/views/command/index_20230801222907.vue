    ...
    <div class="container">
        ...
        <div class="main" v-if="!isCommentSuccess">
            ...
            <div class="commentevaluateText">
                ...
                <van-cell-group inset style="margin-bottom: 80px;">
                    <van-field v-model="selfComment" rows="4" autosize maxlength="200" type="textarea" show-word-limit
                        placeholder="通过这次课程, 我有这些收获...." />
                </van-cell-group>
                <div style="text-align: left;margin-left: 20px;">课程评价</div>
                <van-cell-group inset>
                    <van-field v-model="evaluateText" rows="4" autosize maxlength="200" type="textarea" show-word-limit
                        placeholder="我觉得这个课程..." />
                </van-cell-group>
                <div class="anonymous">
                    <van-switch v-model="anonymous" @change="handleSwitchChange" size="22px" active-color="#E3562A"
            ...
            <div class="commmentToSelf">
                ...
                <div style="text-align: center;margin-bottom: 40px; margin-top: -20px; font-size: 12px; color: gray">若不手动打分,
                    系统会在80~90间随机生成分数</div>
            </div>
        ...
        <div class="res" v-else>
            <van-image width="375" height="253" fit="scale-down" lazy-load :src="resPic" />
            <div class="resText">
                <div style="font-size: 30px; font-weight: 300; color: #9e9e9e;">
                    感<span class="speFont">谢</span>你的宝<span class="speFont">贵</span>意<span class="speFont">见</span>
                </div>
