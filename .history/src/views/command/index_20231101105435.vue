...
const selfCommentDOM = ref<HTMLElement>();
...
const submit = debounce(async () => {
  console.log(selfCommentDOM.value);
  selfComment.value = await selfCommentDOM.value.getContextHTML();
...
const handleSelfCommentChange = (selfCommentText: string) => {
    ...
    <div class="main" v-if="!isCommentSuccess">
      <div class="commentevaluateText">
        ...
        <van-cell-group inset style="margin-bottom: 20px">
          <self-comment-area ref="selfCommentDOM" :level="score" />
        </van-cell-group>
        <div
          style="
            text-align: left;
