...
const courses = reactive(new Array())
const tags = reactive([
    {
        tag: '全部',
        key: '*'
    ...
    <div class="container">
            ...
            <van-sticky :offset-top="50">
                <div class="myInput">
                    <van-cell-group inset>
                        <van-field v-model="selectParams.keyWords" center clearable placeholder="请输入关键词搜索课程">
                            <template #button>
                                <van-icon name="search" color="#3C3A36" @click="getList" size="22" />
                            </template>
                        </van-field>
                    </van-cell-group>
                </div>
        ...
        <div class="list">
            <van-list v-model:loading="loadStatus.loading" :finished="loadStatus.finished" v-model:error="loadStatus.error"
                ...
                <van-cell v-for="( item, index ) in  courses " :key="index" :title="item">
