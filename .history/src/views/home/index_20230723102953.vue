...
const getList = () => {
    console.log(selectParams.keyWords)
    ...
    <div class="container">
        <div class="header">
            ...
            <van-sticky :offset-top="50">
                <search-bar :key-words="selectParams.keyWords" @search-course="getList"
                    @update:key-words="selectParams.keyWords = $event"></search-bar>
                <div class="tag">
