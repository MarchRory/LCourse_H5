    ...
    <div class="container">
        <van-sticky :offset-top="0">
            <header>
                ...
                <div class="title">
                    课<span style="color: #5a5a5a; font-weight: 200;">程</span>规<span
                        style="color: #818181; font-weight: 200;">划</span>
                </div>
                <div class="tools">
        ...
        <div class="list" v-if="!isLoad">
            <div class="object" v-for="(obj, index) in list" :key="index" @click="openObject(obj.id)">
                ...
                <div class="ObjInfo">
                    ...
                    <div>
                        <van-progress v-if="obj.fixRestrictions"
                            :pivot-text="`${(obj.completed / obj.fixRestrictions) * 100}%`" color="#E3562A"
