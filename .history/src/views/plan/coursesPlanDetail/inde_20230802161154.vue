...
const chart = ref()
const waterBallOpts = ref<any>()
const waterBallChart = ref<any>()
...
var getWaterBallOpts = (numerator: number, denominator: number) => {
...
const initwaterBallChart = () => {
    waterBallChart.value = (echarts as any).init(chart.value)
    waterBallOpts.value = getWaterBallOpts(objInfo.value.completed, objInfo.value.fixRestrictions)
}
