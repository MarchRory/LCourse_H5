  ...
  <div class="mainBox">
    ...
    <div class="main">
      <div class="leftSide">
        ...
        >
          <div class="cuboid-top" :style="{ backgroundColor: item.top }"></div>
          <div
            class="cuboid-front"
            :style="{ backgroundColor: item.front }"
          ></div>
          <div
            class="cuboid-aside"
            :style="{ backgroundColor: item.aside }"
          ></div>
        </div>
        <div></div>
      </div>
    ...
    .leftSide {
      ...
      .cuboid {
        ...
        .cuboid-front {
          height: 30px;
          width: 98%;
          transform: rotateY(0deg) translateZ(-30px) translateX(83px)
            translateY(-30px);
        }
        .cuboid-aside {
          height: 29px;
          transform: rotateY(-97deg) translateZ(22px) translateX(-254px);
        }
      }
    }
    .rightSide {
