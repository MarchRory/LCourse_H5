...
const maxScoreCategory = computed(() => {
  ...
  return Object.keys(props.scoreDetails).find((key) => {
    console.log(props.scoreDetails[key], maxScore);
    return props.scoreDetails[key] == maxScore;
  });
});
...
<template>
  <div class="container">
    ...
    <div class="footerText" v-show="isTextLoaded">
      <span style="font-size: 30px">这一年, 你热衷于</span>
