...
const ScoreAndRankingChart = defineAsyncComponent(
  () => import("@/views/annulReport/children/components/scoreAndRanking.vue")
);
const FirstCourse = defineAsyncComponent(
  () => import("@/views/annulReport/children/components/firstCourse.vue")
);
const MaxCourse = defineAsyncComponent(
  () => import("@/views/annulReport/children/components/maxCourse.vue")
);
  ...
  >
    ...
    <transition @enter="onEnter" @leave="onLeave">
      ...
      <ScoreAndRankingChart
        ...
        :ranking="annualReportInfo.ranking"
      />
      <FirstCourse
        v-else-if="currentPage == 4"
        :first-course="annualReportInfo.firstCourse"
      />
      <MaxCourse v-else-if="currentPage == 5" />
    </transition>
