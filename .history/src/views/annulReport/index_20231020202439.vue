...
function openAnnulReport(id: string | number, batchName: string) {
  router.push({
    path: "/reportPage",
    query: { reportId: id, batchName: batchName },
  });
}
function loadList() {
  loading.value = true;
        ...
        >
          <div>
            <van-cell
              ...
              :key="report.id"
              @click="
                openAnnulReport(report.id, report.reportBatchName as string)
              "
            >
              <div class="object">
                <div class="seat">
