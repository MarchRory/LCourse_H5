                        ...
                        <van-list v-model:loading="loading" :finished="finished" finished-text="没有更多了"
                            ...
                            <van-cell v-for="(item, index) in temp" :key="index">
                                <div class="eachEvaluation">
                                    <div class="Info">
                                        <div
                                            style="border-radius: 10px;width: 160px  ;overflow: hidden; border: 2px solid red;">
                                            <van-image width="160px" height="96px" fit="cover"
                                                :src="item.cover || defaultCover" lazy-load>
