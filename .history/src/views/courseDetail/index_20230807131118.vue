  ...
  <div class="details" v-if="!skeLoad">
    ...
    <div class="mainInfo">
      ...
      <div class="application">
        ...
        <div @click="toComment" style="display: flex; flex-direction: column; align-items: center; color: rgba(252, 131, 26, 0.879);
                  margin-top: 10px;" v-if="detailsObj.signUpstate == 3">
