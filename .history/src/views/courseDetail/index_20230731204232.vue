<template>
  <div class="details">
    ...
    <div class="info">
      <div class="time">
        {{ detailsObj.applicationStart }} 至 {{ detailsObj.applicationEnd }}
      </div>
      <div>
        <span class="point">组织</span>
        <span>{{ detailsObj.organizer }}</span>
      </div>
      <div>
        <span class="point">地点</span>
        <span>{{ detailsObj.courseLocation }}</span>
      </div>
      <div>
        <span class="point">简介</span>
      ...
      <div v-if="detailsObj.attachment">
        ...
        <a :href="detailsObj.attachment" target="downloadFile" download></a>
      </div>
    </div>
    ...
    <div class="application">
      ...
      <div style="display: flex; flex-direction: column; align-items: center; color: grey;">
