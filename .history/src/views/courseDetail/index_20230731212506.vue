<template>
  <div class="details">
    ...
    <div class="mainInfo">
      ...
      <div class="info">
        ...
        <div>
          ...
          <span style="font-size: 20px; font-weight: bold; color: #3ae7e7;">{{ detailsObj.numberLimit }}</span>
        </div>
        <div>
    ...
    <div class="application">
      ...
      <div style="display: flex; flex-direction: column; align-items: center; color: rgba(252, 131, 26, 0.879);">
