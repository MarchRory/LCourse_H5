<template>
  <div class="details">
    ...
    <div class="application">
      ...
      <div style="display: flex; flex-direction: column; align-items: center; color: rgb(252, 131, 26);">
        <van-icon v-if="detailsObj.signUpstate != 3" style="color: rgb(252, 131, 26);" name="smile-comment" size="30"
          @click="toComment"></van-icon>
        评价课程
      </div>
    </div>
