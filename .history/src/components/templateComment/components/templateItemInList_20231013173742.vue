...
import { pxToRem } from "@/utils/transform/unit";
...
const completeHeight = ref();
const contextHeightChange = () => {
  isReadMore.value = !isReadMore.value;
  nextTick(() => {
    const node = document.querySelectorAll(".templateItem")[0];
    completeHeight.value = pxToRem(node.scrollHeight);
  });
};
</script>
  ...
  <div>
    ...
    <div class="templateCard">
      <div
        ...
        :style="{ height: isReadMore ? completeHeight : '12rem' }"
      >
        <div
      ...
      <div class="readmore" @click="contextHeightChange">
        <van-icon
          :style="{
...
.templateCard {
  ...
  .templateItem {
    ...
    background: #ffffff;
    transition: height 0.3s ease-in-out 0.1;
