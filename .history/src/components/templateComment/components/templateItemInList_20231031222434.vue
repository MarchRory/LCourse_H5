...
const emits = defineEmits<{
  (e: "onChoose", index: number): void;
}>();
const isReadMore = ref(false);
const templateItem = ref();
const choose = () => {
  emits("onChoose", props.index);
};
</script>
...
<template>
  <div>
    <div class="header">
      ...
      <div class="leaf" @click.self="choose">
        <div class="chooseBtn">
          <van-icon name="certificate" size="20" /> <span>选择</span>
        </div>
        <svg
          t="1697166617858"
    ...
    <div class="templateCard">
      ...
      >
        <div
          ...
          v-html="props.templateCommentText.templateText"
        ></div>
      </div>
