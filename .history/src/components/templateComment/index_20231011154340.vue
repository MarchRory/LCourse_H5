...
<template>
  <div :class="[isUse ? 'templateActive' : 'templateDisabled']">
    <ul v-if="isUse" @click="openTemplateSwitch">
      <li><van-icon name="replay" size="20" /></li>
      <li style="margin-left: 5px">重新选择</li>
    </ul>
    <div class="commenArea" @click="beginComment">
      <span v-if="!isUse" class="notice">打分后可以使用自我评价文本模板</span>
      <div v-else>
        <article></article>
      </div>
    </div>
