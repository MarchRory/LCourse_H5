...
.templateItem {
  ...
  border-radius: 10px;
  text-align: left;
  border: 1px solid rgb(210, 122, 34);
  box-shadow:
    1.6px 3.3px 4.2px rgba(0, 0, 0, 0.024),
    4.5px 9.1px 11.6px rgba(0, 0, 0, 0.035),
    10.9px 22px 28px rgba(0, 0, 0, 0.046),
    36px 73px 93px rgba(0, 0, 0, 0.07);
}
.templateListBox {
