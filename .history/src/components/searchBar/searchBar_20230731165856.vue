...
<template>
    <div class="component-searchBar">
        <van-cell-group inset>
            <van-field :disabled="true" :model-value="inputProps.keyWords" @update:model-value="changeInputValue"
                type="text" center placeholder="请输入关键词搜索课程">
                <template #button>
                    <van-icon name="search" color="#3C3A36" size="22" @click="searchCourse" />
                </template>
            </van-field>
        </van-cell-group>
    </div>
