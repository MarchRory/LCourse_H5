<template>
  <div id="app">
    <div>
      <van-notice-bar
        v-show="notifyShow"
        style="position: fixed; top: 30px; z-index: 9999; width: 70%"
        left-icon="volume-o"
        mode="closeable"
        :text="notifyText"
      />
...
setInterval(() => {
  setTimeout(() => {
    notifyStore.text = "success, hello TypeScript";
    notifyStore.isShow = !notifyStore.isShow;
  }, 2000);
});
</script>
