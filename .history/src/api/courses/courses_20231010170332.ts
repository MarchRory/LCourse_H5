...
import { commentTemplateResultModel, templateAndVocabularyListParamsType } from "../types/comment";
...
export default {
   ...
   * 获取评价模板
   */
  async getCommentTemplateAPI(params: templateAndVocabularyListParamsType) {
    return await request.get<commentTemplateResultModel>({
      url: '/curriculum/template/page',
      params: params
    })
  },
  async getVocabularyCategoriesAPI(params: templateAndVocabularyListParamsType)
};
