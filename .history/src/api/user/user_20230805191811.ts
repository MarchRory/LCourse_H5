...
export default {
  ...
  async yibanBind(userId: number) {
    return (window.location.href = import.meta.env.VITE_APP_BASE_URL + `/user/yiban/bind?id=${userId}&callback=${import.meta.env.VITE_APP_YIBANBIND_CALLBACK}`);
  },
